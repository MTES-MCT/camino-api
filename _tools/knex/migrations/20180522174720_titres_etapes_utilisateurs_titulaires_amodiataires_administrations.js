  ...
  return knex.schema
    .createTable('titres_titulaires', table => {
      ...
      table
        ...
        .notNullable()
      table.primary(['titre_demarche_etape_id', 'entreprise_id'])
    })
    ...
    .createTable('titres_utilisateurs', table => {
      ...
      table
        ...
        .notNullable()
      table.primary(['titre_demarche_etape_id', 'utilisateur_id'])
    })
    .createTable('titres_administrations', table => {
      ...
      table
        ...
        .notNullable()
      table.primary(['titre_demarche_etape_id', 'administration_id'])
    })
}
