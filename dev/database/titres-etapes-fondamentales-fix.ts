...
import { ITitreEtape, ITitreIncertitudes } from '../../src/types'
import EtapesTypes from '../../src/database/models/etapes-types'
...
import TitresPoints from '../../src/database/models/titres-points'
