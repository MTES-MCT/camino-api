  ...
  for (const demarche of demarches) {
    if (demarche.etapes?.length) {
      ...
      if (demandeEtape && depotDemandeEtape) {
        ...
        if (depotDemandeEtape.incertitudes?.date) {
          if (!demandeEtape.incertitudes) {
            demandeEtape.incertitudes = {}
          }
          demandeEtape.incertitudes.date = true
        }
      ...
      if (demandeEtape) {
        await TitresEtapes.query()
          .patch({
            ...
            incertitudes: demandeEtape.incertitudes
          })
