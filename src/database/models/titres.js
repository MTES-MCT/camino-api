...
const titrePaysFormat = communes => {
...
export default class Titres extends Model {
  ...
  static relationMappings = {
    ...
    administrationsCentrales: {
      ...
      join: {
        from: 'titres.id',
        through: {
          from: 'titresAdministrationsCentrales.titreId',
          to: 'titresAdministrationsCentrales.administrationId',
          extra: ['subsidiaire']
        },
  ...
  $afterGet() {
    this.pays = titrePaysFormat(this.communes)
  }
