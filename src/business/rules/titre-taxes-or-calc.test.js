...
describe("calcule la taxe d'un type d'une annee pour un titre", () => {
  ...
  test("calcule la taxe d'un titre en 2017", () => {
    ...
    expect(res).toEqual([
      {
        annee: 2017,
        contenu: { investissements: 0, montant: 40, tonnageExtrait: 400 },
  ...
  test("calcule la taxe d'un titre en 2018", () => {
    ...
    expect(res).toEqual([
      {
        annee: 2018,
        contenu: { investissements: 0, montant: 36, tonnageExtrait: 300 },
        frequencePeriodeId: 12,
        taxeTypeId: 'rco',
        titreId: 'h-cxx-courdemanges-1988'
      }
  ...
  test("modifie la taxe d'un titre", () => {
    ...
    expect(res).toEqual([
      {
        annee: 2018,
        contenu: { investissements: 0, montant: 12, tonnageExtrait: 100 },
        frequencePeriodeId: 12,
        taxeTypeId: 'rco',
        titreId: 'h-cxx-courdemanges-1988'
      }
  ...
  test("ajoute un investissement si il s'agit de la taxe sur l'or", () => {
    ...
    expect(res).toEqual([
      {
        annee: 2018,
        contenu: { investissements: 14, montant: 30, tonnageExtrait: 300 },
        frequencePeriodeId: 12,
        taxeTypeId: 'tor',
        titreId: 'h-cxx-courdemanges-1988'
      }
